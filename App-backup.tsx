...
const InputPanel = ({ topic, setTopic, duration, setDuration, onOpenGuide, model, product, onAddModel, onAddProduct }: {
    ...
    <div className="glass rounded-2xl p-6 mb-6 border border-white/[0.08]">
        <div className="grid grid-cols-3 gap-4">
            ...
            <div className="relative">
                ...
                <button 
                    onClick={onAddModel}
                    className="mt-3 w-full px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl text-sm font-medium hover:shadow-lg transition-all hover:scale-[1.02]"
                >
            ...
            <div className="relative">
                ...
                <button 
                    ...
                    className="mt-3 w-full px-4 py-2 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl text-sm font-medium hover:shadow-lg transition-all hover:scale-[1.02]"
                >
...
export default function App() {
    ...
    const handleFullGeneration = useCallback(async () => {
        ...
        let storyboardData;
        try {
            storyboardData = await geminiService.generateStoryboard(topic, '', duration, '');
